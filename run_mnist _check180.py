...
# ============================================================
# Chemins Kaggle - reprise depuis checkpoint epoch 180
# ============================================================

SAVE_DIR = "/kaggle/working/mnist_swot_flow_flows12_resume180_lr1e4"
OUTDIR = "/kaggle/working/mnist_swot_flow_flows12_resume180_lr1e4/mnist_results"
...
def main():
    ...
    # ========================================================
    # Reprendre un entraînement depuis checkpoint
    # ========================================================
    ...
    if RESUME:
        ...
        # Important : le checkpoint restaure l'ancien optimizer.
        # Donc on force le nouveau learning rate après chargement.
        for param_group in optimizer.param_groups:
            param_group["lr"] = lr

        print("Checkpoint chargé depuis :", RESUME_CHECKPOINT_PATH)
        print("Reprise à partir de epoch :", start_epoch)
        print("Nouveau learning rate appliqué :", lr)

    # Pour sauvegarder automatiquement le meilleur checkpoint
    best_loss = min(loss_history) if len(loss_history) > 0 else float("inf")
    print("Meilleure loss avant reprise :", best_loss)
    ...
    print("RESUME_CHECKPOINT_PATH =", RESUME_CHECKPOINT_PATH)
    print("________________________________")
    ...
    model_path = os.path.join(SAVE_DIR, "mnist_swot_flow_flows12_resume180_lr1e4.pth")
